 ...
 *
 * Этот файл содержит разметку и функции для вывода шапки сайта.
    ...
    <header class="site-header">
      <div class="container">
        <h1 class="school-logo-text float-left">
          <a href="<?php echo site_url()?>"><b>Bridge</b style="font-weight:600;"> Communuity</a>
        </h1>
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            <ul>
              ...
              <li <?php if ( get_post_type() == 'play') echo 'class=current-menu-item'; ?>><a href="<?php echo get_post_type_archive_link('play');?>">Plays</a></li>
          ...
          <div class="site-header__util">          
            ...
            <?php             
            } else {// и для неавторизованного пользователя ?>
